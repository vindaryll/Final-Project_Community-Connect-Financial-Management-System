...
{
    public partial class Form6_cashin : Form
    {
        ...
        {
            // Open Form5_UnallocatedFundInfo
            OpenForm(new Form5_UnallocatedFundInfo());
        }
        private void btn_submit_Click_1(object sender, EventArgs e)
        {
            // Check if source or amount fields are empty
            if (string.IsNullOrEmpty(txt_source.Text) || string.IsNullOrEmpty(txt_amount.Text))
            {
            ...
            // Add "Cash in(Add balance)" record to the database
            func.cashin(amount, source, date_time_db);
