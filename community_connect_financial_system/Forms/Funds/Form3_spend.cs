...
{
    public partial class Form3_spend : Form
    {
        ...
        private void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txt_reason.Text) || string.IsNullOrEmpty(txt_amount.Text))
            {
            ...
            func.expenses(Pv.fundID[Pv.fundIndex - 1], amount, reason, date_time_db);
